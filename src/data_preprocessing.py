...
class DataProcessor:
    ...
    def preprocess_data(self,df):
        try:
            ...
            logger.info("Doing Skeweness Handling")
            ...
            logger.error(f"Errror during proprocessstep {e}")
    ...
    def balance_data(self,df):
        try:
            ...
            logger.error(f"Errror during balancing data step {e}")
    ...
    def select_feature(self,df):
        try:
            ...
            logger.info("Features selection completed successfully")

            return top_10_df
        except Exception as e:
            logger.error(f"Errror during feature selection  step {e}")
    ...
    def save_data(self,df,file_path) :
        try:
            ...
            logger.error(f"Errror during saving data  step {e}")
    ...
    def process(self):
        try:
            ...
            logger.error(f"Errror during preprocessing pipeline   step {e}")
            raise CustomException("Error while datapreprocessing pipeline ",e) 
