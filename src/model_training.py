...
class ModelTraining:
    ...
    def load_and_split_data(self):
        try:
            ...
            logger.error("Error occur while loading data",{e})
    ...
    def train_lgbm(self,X_train,y_train):
            try:
                ...
                logger.error("Error occur while training model ",{e})
    ...
    def save_model(self,model):
        try:
            ...
            logger.info(f"Model Saved to {self.model_output_path}")
                ...
                logger.error("Error occur while saving model ",{e})
    ...
    def run(self):
        try:
            ...
            logger.error("Error occur in model training pipeline ",{e})
            raise CustomException("Failed to during training pipeline",e)
